...
export default class KeypadSolver {
    static COLUMNS = [
        ...
        [KeypadSymbol.WEIRD_6, KeypadSymbol.BACKWARDS_PARAGRAPH, KeypadSymbol.LETTER_B_WITH_CROSS, KeypadSymbol.KITTY, KeypadSymbol.MIRRORED_PAIR_OF_KS, KeypadSymbol.UPSIDE_DOWN_QUESTION_MARK, KeypadSymbol.SMILEY_FACE],
