...
const MAZE_6_CIRCLES = [
    [1, 5],
    [5, 3]
];

const MAZE_6 = [
    [new MazeCell(true, false), new MazeCell(false, false), new MazeCell(true, false), new MazeCell(false, true), new MazeCell(false, false), new MazeCell(true, false)],
    [new MazeCell(true, false), new MazeCell(true, false), new MazeCell(true, false), new MazeCell(false, false), new MazeCell(true, true), new MazeCell(true, false)],
    [new MazeCell(false, false), new MazeCell(true, true), new MazeCell(true, true), new MazeCell(true, false), new MazeCell(false, false), new MazeCell(true, true)],
    [new MazeCell(false, true), new MazeCell(true, false), new MazeCell(false, false), new MazeCell(true, false), new MazeCell(true, false), new MazeCell(true, false)],
    [new MazeCell(false, false), new MazeCell(true, true), new MazeCell(true, true), new MazeCell(true, false), new MazeCell(false, true), new MazeCell(true, false)],
    [new MazeCell(false, true), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(true, true), new MazeCell(false, true), new MazeCell(true, true)]
];

const MAZE_7_CIRCLES = [
    [1, 2],
    [6, 2]
];

const MAZE_7 = [
    [new MazeCell(false, false), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(true, false), new MazeCell(false, false), new MazeCell(true, false)],
    [new MazeCell(true, false), new MazeCell(false, false), new MazeCell(true, true), new MazeCell(false, true), new MazeCell(true, true), new MazeCell(true, false)],
    [new MazeCell(false, true), new MazeCell(true, true), new MazeCell(false, false), new MazeCell(true, true), new MazeCell(false, false), new MazeCell(true, true)],
    [new MazeCell(false, false), new MazeCell(true, false), new MazeCell(false, false), new MazeCell(false, true), new MazeCell(true, true), new MazeCell(true, false)],
    [new MazeCell(true, false), new MazeCell(true, true), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(true, false), new MazeCell(true, false)],
    [new MazeCell(false, true), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(true, true)]
];

const MAZE_8_CIRCLES = [
    [1, 4],
    [4, 2]
];

const MAZE_8 = [
    [new MazeCell(true, false), new MazeCell(false, false), new MazeCell(false, true), new MazeCell(true, false), new MazeCell(false, false), new MazeCell(true, false)],
    [new MazeCell(false, false), new MazeCell(false, true), new MazeCell(true, true), new MazeCell(false, true), new MazeCell(true, false), new MazeCell(true, false)],
    [new MazeCell(true, false), new MazeCell(false, false), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(true, false), new MazeCell(true, false)],
    [new MazeCell(true, false), new MazeCell(false, true), new MazeCell(true, false), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(true, true)],
    [new MazeCell(true, false), new MazeCell(true, false), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(true, true)],
    [new MazeCell(false, true), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(true, true)]
];

const MAZE_9_CIRCLES = [
    [2, 3],
    [5, 1]
];

const MAZE_9 = [
    [new MazeCell(true, false), new MazeCell(false, false), new MazeCell(false, true), new MazeCell(false, true), new MazeCell(false, false), new MazeCell(true, false)],
    [new MazeCell(true, false), new MazeCell(true, false), new MazeCell(false, false), new MazeCell(true, true), new MazeCell(true, false), new MazeCell(true, false)],
    [new MazeCell(false, false), new MazeCell(false, true), new MazeCell(true, true), new MazeCell(false, false), new MazeCell(true, true), new MazeCell(true, false)],
    [new MazeCell(true, false), new MazeCell(true, false), new MazeCell(false, false), new MazeCell(true, true), new MazeCell(false, true), new MazeCell(true, false)],
    [new MazeCell(true, false), new MazeCell(true, false), new MazeCell(true, false), new MazeCell(false, false), new MazeCell(true, false), new MazeCell(true, true)],
    [new MazeCell(false, true), new MazeCell(true, true), new MazeCell(false, true), new MazeCell(true, true), new MazeCell(false, true), new MazeCell(true, true)]
];
...
export default class MazesSolver {
    ...
    static solve(circles, red_triangle_coords, white_square_coords) {
        ...
        if (circles_comp(circles, MAZE_6_CIRCLES)) {
            return this.#solveMaze(MAZE_6, normalized_white_square, normalized_triangle);
        }

        if (circles_comp(circles, MAZE_7_CIRCLES)) {
            return this.#solveMaze(MAZE_7, normalized_white_square, normalized_triangle);
        }

        if (circles_comp(circles, MAZE_8_CIRCLES)) {
            return this.#solveMaze(MAZE_8, normalized_white_square, normalized_triangle);
        }

        if (circles_comp(circles, MAZE_9_CIRCLES)) {
            return this.#solveMaze(MAZE_9, normalized_white_square, normalized_triangle);
        }
